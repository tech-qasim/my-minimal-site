...
cover: 'assets/Markdown-syntax-guide.webp'
ogImage: 'assets/Markdown-syntax-guide.webp'
---
...
_Critical timing_ uses italics
**_Special notes_** use both bold and italics
...
![Pasta dish](assets/food.webp)(style:width:50%)
