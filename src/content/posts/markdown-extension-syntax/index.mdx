...
author: 'Dnzzk2'
recommend: true
cover: 'assets/markdown-extension-syntax.png'
ogImage: 'assets/markdown-extension-syntax.png'
tags: ['Markdown', 'Guide']
---
...
![](assets/markdown-extension-syntax.png)
:::

:::image-figure[This is a **figcaption** with _`<img>` attrs_.]
![](assets/markdown-extension-syntax.png)(style: width:600px;)
:::

<!-- 💡 Use `(class:no-zoom)` to disable zoom -->

:::image-figure[This is a **figcaption** with `class:no-zoom`.]
![](assets/markdown-extension-syntax.png)(class:no-zoom)
:::

<!-- 💡 If no `[caption]`, use `[alt]` as figcaption. -->

:::image-figure
![If `[caption]` not set, the alt text from `![]()` will be used as the figcaption.](assets/markdown-extension-syntax.png)
:::
...
:::image-figure[This example shows different images for light (add `class:img-light`) and dark (add `class:img-dark`) modes.]
![](assets/image-16-9-dark.png)(class:img-light)
...
![OG image](assets/markdown-extension-syntax.png)
:::

:::image-a{href="https://github.com/Dnzzk2/Litos" style="display:block" .custom-class}
![OG image](assets/markdown-extension-syntax.png)(style: margin-bottom: -1rem; transform:scaleX(1.1) scaleY(1.1);, loading: eager)
:::
...
::::image-a{href="https://github.com/Dnzzk2/Litos"}
:::image-figure[This example shows `:::image-a` wraps around `:::image-figure` (both are interchangeable).]
![OG image](assets/markdown-extension-syntax.png)(style:padding-top:1rem;)
:::
::::
