...
recommend: true
cover: 'assets/MD-Configuration.webp'
ogImage: 'assets/MD-Configuration.webp'
---
...
| cover            | string   | No       | -       | Featured image filename (stored in `public/cover-images/`) or external URL                               |
| ogImage          | string   | No       | -       | Social media preview image (stored in `public/og-images/`) or external URL                               |
| coverLayout      | string   | No       | -       | Image positioning ('left' or 'right') for post listings; takes precedence when post list type is 'image' |
| coverAspectRatio | string   | No       | '16/9'  | Image aspect ratio, supports '16/9' or '3/4'                                                             |
...
- If `cover` is not specified, the system uses `cover` from `POSTS_CONFIG` in `config.ts`
...
The theme supports three distinct image display styles based on the `cover` configuration:

1. Without Cover Image:
   :::image-figure[noImage]
   ![](assets/noImage-dark.webp)(class:img-light)

![](assets/noImage-light.webp)(class:img-dark)
:::

2. With Cover Image (Default 16/9 Ratio):
   :::image-figure[16/9]
   ![](assets/image-16-9-dark.webp)(class:img-light)

![](assets/image-16-9-light.webp)(class:img-dark)
:::

3. With Cover Image (3/4 Ratio):
   :::image-figure[3/4]
   ![](assets/image-3-4-dark.webp)(class:img-light)

![](assets/image-3-4-light.webp)(class:img-dark)
:::
...
### Cover image and OG image

Cover images and OG images play crucial roles in enhancing your content's visual appeal and social media presence. Here are some recommended tools and guidelines for creating effective images:
...
- **Additional Fields**:
  ...
  - `coverAspectRatio`: Fixed to '16/9'
...
- **Additional Fields**:
  - Same as 16/9 template, but `coverAspectRatio` is fixed to '3/4'
